...
function MemoActionsMenu() {
    const {setIsBombMemoActive, setIs1MemoActive, setIs2MemoActive, setIs3MemoActive, isBombMemoActive, is1MemoActive, is2MemoActive, is3MemoActive} = useContext(AppContext)
  return (
